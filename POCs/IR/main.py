...
# Thread d'envoi WebSocket non bloquant
...
def preprocess(gray):
    """
    Applique un flou léger et une ouverture morphologique
    pour réduire les artefacts avant HoughCircles.
    """
...
def find_brightest_circle(gray, clean):
    """
    Détecte tous les cercles sur l'image 'clean' puis
    choisit celui dont la région sur l'image 'gray' est la plus lumineuse.
    """
    ...
    # Pour chaque cercle, calculer la luminosité moyenne de gray à l'intérieur
